...
Source0: https://github.com/Defensec/dssp2-standard/archive/%{commit0}/dssp2-standard-%{commit0}.tar.gz
Source1: https://github.com/Defensec/dssp2-base/archive/%{commit1}/dssp2-base-%{commit1}.tar.gz
URL: https://github.com/Defensec/dssp2-standard/wiki
...
%package standard
Summary: Standard Defensec SELinux Security Policy Version 2
Group: System Environment/Base
...
SELinux security policy written in native Common Intermediate Language
Provides the standard Defensec SELinux Security Policy package.

%files standard
%fileList dssp2-standard

%prep
%autosetup -n dssp2-standard-%{commit0}
%autosetup -n dssp2-standard-%{commit0} -a 1
rmdir policy/base
